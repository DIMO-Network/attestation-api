...
//
//	mockgen -source=interfaces.go -destination=interfaces_mock_test.go -package=odometerstatementvc_test
//

// Package odometerstatementvc_test is a generated GoMock package.
