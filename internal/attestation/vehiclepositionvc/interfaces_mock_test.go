...
//
//	mockgen -source=interfaces.go -destination=interfaces_mock_test.go -package=vehiclepositionvc_test
//

// Package vehiclepositionvc_test is a generated GoMock package.
